...
namespace Lab2Ex6.BiblWorm
{
    public partial class Form1 : Form
    {
        ...
        List<Lab2Ex6.BiblWorm.Item> its = new List<Lab2Ex6.BiblWorm.Item>();

        private void button1_Click_1(object sender, EventArgs e)
        {
            Lab2Ex6.BiblWorm.Book b = new Lab2Ex6.BiblWorm.Book(Author, Title, PublishHouse, Page, Year, InvNumber, Existence);
        ...
        {
            {
                ...
                foreach (Lab2Ex6.BiblWorm.Item item in its)
                {
                    sb.Append("\n" + item.ToString());
                }
